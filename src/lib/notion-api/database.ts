 ...
 */
export const getDatabase = (database_id: string) => notion.databases.retrieve({ database_id });
 ...
 * @param params QueryDatabaseParameters
 */
export const getDatabaseContentsAll = async (params: QueryDatabaseParameters) => {
  const postArray = [];
